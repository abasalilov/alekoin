...
contract("Token ERC23", function(accounts) {
  // CREATION
  it("creation: should create an initial balance of 10000000000000000 for the creator", function(done) {
    var ctr;
  ...
  // TRANSERS
  it("transfers: should transfer 10000000000000000 to accounts[1] with accounts[0] having 10000000000000000", function(done) {
    var ctr;
    Token.new({ from: accounts[0] })
      .then(function(result) {
        ctr = result;
  ...
  it("transfers: should transfer 10000000000000000 to overrider contract with accounts[0] having 10000000000000000", function(done) {
    var ctr, receiver;
    Token.new({ from: accounts[0] })
      .then(function(result) {
        ctr = result;
  ...
  it("transfers: should fail when trying to transfer 10000000000000001 to accounts[1] with accounts[0] having 10000000000000000", function(done) {
    var ctr;
    Token.new({ from: accounts[0] })
      .then(function(result) {
        ctr = result;
